...
;(function () {
  ...
  function cachePush(value) {
    ...
    if (type == 'boolean' || value == null) {
      ...
      var _key = type == 'number' ? value : keyPrefix + value,
          typeCache = cache[type] || (cache[type] = {});

      if (type == 'object') {
        (typeCache[_key] || (typeCache[_key] = [])).push(value);
      } else {
        typeCache[_key] = true;
      }
    }
  ...
  function runInContext(context) {
    ...
    (function () {
      ...
      while (length--) {
        var _key2 = shadowedProps[length];
        for (var className in nonEnumProps) {
          if (hasOwnProperty.call(nonEnumProps, className) && !hasOwnProperty.call(nonEnumProps[className], _key2)) {
            nonEnumProps[className][_key2] = false;
          }
        }
      }
    })();
