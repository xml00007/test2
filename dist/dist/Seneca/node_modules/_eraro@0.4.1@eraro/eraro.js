...
function eraro(options) {
  ...
  var msgprefix = false === options.prefix ? '' : _.isString(options.prefix) ? options.prefix : _.isString(options.package) ? options.package + ': ' : '';
  ...
  var errormaker = function errormaker(ex, code, msg, details) {
...
function buildmessage(options, msg, msgmap, msgprefix, inspect, code, details, ex) {
  var message = msgprefix + (_.isString(msg) ? msg : _.isString(msgmap[code]) ? msgmap[code] : ex ? originalmsg(options.override, ex) : code);
