...
;(function () {
    ...
    function bound() {
      ...
      if (this instanceof bound) {
        ...
        var thisBinding = baseCreate(func.prototype),
            _result = func.apply(thisBinding, args || arguments);
        return isObject(_result) ? _result : thisBinding;
      }
  ...
  function baseCreateWrapper(bindData) {
    ...
    function bound() {
      ...
      if (partialArgs) {
        var _args2 = slice(partialArgs);
        push.apply(_args2, arguments);
      }
      ...
      if (this instanceof bound) {
        ...
        var _result3 = func.apply(thisBinding, args);
        return isObject(_result3) ? _result3 : thisBinding;
      }
  ...
  function map(collection, callback, thisArg) {
    ...
    callback = createCallback(callback, thisArg, 3);
    if (typeof length == 'number') {
      var _result5 = Array(length);
      while (++index < length) {
        _result5[index] = callback(collection[index], index, collection);
      }
    } else {
      result = [];
      forOwn(collection, function (value, key, collection) {
