...
var that = moment("2017-07-30T11:38:41.000Z");
var timeSpan = that.diff(Date.now(), 'hour', true);
console.log('timeSpan', timeSpan);

console.log(Date(moment(Date.now()).format('YYYY-MM-DD HH:mm:ss SSS')));
console.log(_typeof(moment(Date.now()).format('YYYY-MM-DD HH:mm:ss SSS')));
//# sourceMappingURL=moment_test.js.map